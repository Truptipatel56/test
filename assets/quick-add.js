          ...
          responsive: [
    {
      ...
      settings: {
		...
		asNavFor: '.slider_main',
         focusOnSelect: true,
            prevArrow: '<button type="button" class="slick-prev slick-prev_arr"><i class="fa fa-angle-up"></i></button>',
		nextArrow: '<button type="button" class="slick-next slick-next_arr"><i class="fa fa-angle-down"></i></button>',
        responsive: [
    {
      breakpoint: 992,
      settings: {
